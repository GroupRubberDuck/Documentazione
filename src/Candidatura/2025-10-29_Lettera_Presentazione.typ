...
#insertRomanNumberedPagesSenzaData(PageTitle: "Registro modifiche", documentType: "Lettera di presentazione")[
  ...
  #registroModifiche((
    ("0.1", "29-10-2025", "Stesura bozza della lettera di presentazione", "Ana Maria Draghici", ""),
...
#insertArabicNumberedPagesSenzaData(PageTitle: "Lettera di presentazione", documentType: "Lettera di presentazione")[
  ...
  Il gruppo *RubberDuck* dichiara una disponibilità media al progetto e comunica il proprio impegno nel completarne la realizzazione entro il *30 Aprile 2026*, con un costo stimato pari a *11 910,00 €* .
  ...
  Per maggiori informazioni sul gruppo e sulla documentazione prodotta, è possibile consultare il nostro repository pubblico:  #align(center)[
    *#link("https://github.com/GroupRubberDuck/Documentazione")[github.com/GroupRubberDuck/Documentazione]*
  ]
  ...
  - i verbali esterni, inclusi l’incontro formativo con M31 S.r.l.;  \
