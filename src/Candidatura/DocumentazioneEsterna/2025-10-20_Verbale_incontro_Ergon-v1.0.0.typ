...
#insertRomanNumberedPages("Registro modifiche","Verbale Esterno",giornoRiunione)[
  ...
  ([0.1.0], giornoRiunione.display(), [Aldo Bettega \ Davide Lorenzon], [Filippo Guerra], [Prima stesura],),
  ([1.0.0], [2025-10-29], [Gianluca Carlesso], [Gianluca Carlesso], [Approvazione])
  ))
]
...
#line(length: 100%)
== Metriche di performance prioritarie
...
#line(length: 100%)
==  La gestione degli input ambigui o incompleti
...
#line(length: 100%)
== Interfaccia utente e input multipli
...
#line(length: 100%)
== Target utente e lingua supportata
...
#line(length: 100%)
== Numero medio di ordini giornalieri
...
#line(length: 100%)
== Preferenze piattaforme scalabilità
...
#line(length: 100%)
== Uso e specializzazione strumenti AI esistenti
...
#line(length: 100%)
== Punti guida più importanti e complessi
...
#line(length: 100%)
== Dati per il fine-tuning forniti
