...
#let giornoRiunione = datetime(year: 2025, month: 10, day: 18)

#frontPage([Verbale riunione], giornoRiunione)

#insertRomanNumberedPages("Registro Modifiche", "Verbale Interno", giornoRiunione)[
  #registroModifiche((
    ([0.1.0], [2025-10-18], [Davide Lorenzon], [Ana Maria Draghici],[Prima stesura]),
    ([1.0.0],[2025-10-19],[Davide Testolin],[Davide Testolin],[Approvazione])
  ))
]
...
#insertArabicNumberedPages("Ordine del giorno", "Verbale Interno", giornoRiunione)[
  ...
  #align()[
    ...
    #list(
      marker: [‣],
    )[Scelta dei capitolati][Scelta del way of working][Struttura dei documenti][Brainstorming sui TODO]
...
#insertArabicNumberedPages("Riassunto della riunione ", "Verbale Interno", giornoRiunione)[
  ...
  - Le disponibilità dei vari membri del gruppo
...
#insertArabicNumberedPages("Decisioni", "Verbale Interno", giornoRiunione)[
  ...
  #let decisioni = (
    (
      [#getCode(prefisso: "VI.1.", contatore: contatoreDecisioni)],
      [
...
#insertArabicNumberedPages("TODO", "Verbale Interno", giornoRiunione)[
  ...
  #let TODO = (
    ...
    (
      [#getCode(prefisso: "TD.1.", contatore: contatoreTodo)],
      [Tutti],
      [Stilare la lista delle domande da porre alle aziende],
      [VI.1.1],
    ),
