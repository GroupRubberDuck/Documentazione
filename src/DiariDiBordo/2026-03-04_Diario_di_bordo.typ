...
- Sviluppo di automazioni per la gestione del progetto, tra cui il calcolo automatico del ricavo ore per persona e commit relativi e la numerazione automatica dei casi d'uso e dei requisiti.
- La maggior parte dei documenti (Piano di Progetto, Glossario e verbali precedenti) è stata revisionata accuratamente e portata a un buon livello di completezza. È stata inoltre richiesta formalmente una conferma sui casi d'uso al Professor Cardin, e avviato uno scambio con l'azienda proponente tramite Telegram per ottenere un riscontro ufficiale.
...
- Definizione delle strategie di testing nel Piano di Qualifica: il documento manca ancora della sezione relativa al testing di prodotto, il cui completamento è subordinato alla finalizzazione dei casi d'uso, attualmente in fase di chiusura.
