...
#let use-case-nome="Annullamento inserimento dispositivo"
...
#use-case-template(
    ...
    pre-condizioni:[
        ...
        - L'utente sta inserendo un nuovo dispositivo  #sym.arrow #use-case-label(nome-etichetta: "Inserimento nuovo dispositivo")
    ],
