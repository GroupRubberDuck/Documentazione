...
#use-case-template(
    ...
    scenario-principale:[
        ...
        + L'utente scarica un file JSON contenente i dati del dispositivo sul proprio file system
    ...
    post-condizioni:[
        ...
        - L'utente ha scaricato un file JSON contenente i dati del dispositivo
    ],
