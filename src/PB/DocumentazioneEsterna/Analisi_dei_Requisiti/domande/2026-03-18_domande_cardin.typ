...
#image("/src/PB/DocumentazioneEsterna/Analisi_dei_Requisiti/content/use_case/diagrammi-attivita/images/valuta-dispositivo.drawio.png")
]

#figure(caption:"UC Valuta asset")[
#image("/src/PB/DocumentazioneEsterna/Analisi_dei_Requisiti/content/use_case/diagrammi-attivita/images/valuta-asset.drawio.png")
]

#figure(caption:"UC Modifica modello")[
#image("/src/PB/DocumentazioneEsterna/Analisi_dei_Requisiti/content/use_case/diagrammi-attivita/images/modifica-struttura-modello.drawio.png")
]
