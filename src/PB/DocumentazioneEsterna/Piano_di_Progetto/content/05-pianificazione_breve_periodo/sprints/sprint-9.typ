...
#let sprint_data = (
  ...
  *Consuntivo di periodo: azioni svolte e consumi rilevati.*
  ...
  - *Specifica Tecnica*: affinamento dell'architettura logica esagonale (pro e contro); prima stesura della sezione dei design pattern (Strategy, Observer, Command, Adapter); prima redazione dei diagrammi di sequenza.
  - *Manuale Utente*: prima stesura sezioni introduttive.
  - *Piano di Progetto*: aggiornato con nuova struttura della getione delle attività su indicaazione del professor Vardanega.
  ...
  *Grado di raggiungimento degli obbiettivi.*
  Gli obbiettivi dello sprint 9 sono stati raggiunti parzialmente:
  - *Raggiunti*: stesura architettura logica ST; redazione diagrammi di sequenza; avvio design
  pattern; prima stesura Manuale Utente; aggiornamento PdP.
  - *Parzialmente Raggiunti*: a sezione dei design pattern è in bozza e richiederà revisione;
  - *Non Raggiunti*: l'inizio della progettazione del diagramma delle classi, pianificato come obbiettivo secondario, è slittato allo sprint 10.
  La ragione presunta dello scostamento orario è: la sottostima delle attività di verifica in questo sprint.
  ...
  *Misure correttive e aggiornamento dell'analisi dei rischi.*
  ...
  - *Procasso di Approvazione*: tutti i task dovranno transitare per lo stato «In approvazione» prima di essere spostati in «Done», al fine di facilitare la retrospettiva.
  ...
  *Miglioramento della pianificazione futura*
  - *Breve termine*: 
    ...
    - Ruoli assegnati: Responsabile — Davide Testolin; Amministratore — Felician Mario Necsulescu; Progettisti — tutto il gruppo; Verificatori — Filippo Guerra, Davide Lorenzon.
  - *Lungo termine*:
