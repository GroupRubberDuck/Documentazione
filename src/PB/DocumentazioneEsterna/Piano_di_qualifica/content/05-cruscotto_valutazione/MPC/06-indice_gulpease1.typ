...
#import template_dir + "/indiceGulpease/textExtractor.typ": extract_text_smart
...
#let listaDocumenti = (
  ...
  "Manuale Utente": "/src/PB/DocumentazioneEsterna/Manuale_Utente/Manuale_Utente.typ",
  "Specifica Tecnica": "/src/PB/DocumentazioneEsterna/Specifica_Tecnica/Specifica_Tecnica.typ",
)

#text(size: 0.85em, fill: luma(80))[
  Misura la leggibilità dei documenti prodotti in base a lunghezza delle frasi e delle parole.
  Serve a garantire che la documentazione sia comprensibile per il pubblico di riferimento.
  Ottimale: > 60 per lettori con diploma, > 80 per lettori con licenza media.
]
