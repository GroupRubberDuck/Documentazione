...
#insertArabicNumberedPages("Informazioni generali", "Domande", giornoRiunione)[
  ...
  == Outbound Port
  Nella definizione delle outbound port è corretto poi creare un’interfaccia che eredita da alcune outbound port e poi realizzare un singolo adapter che implementa questa porta,
