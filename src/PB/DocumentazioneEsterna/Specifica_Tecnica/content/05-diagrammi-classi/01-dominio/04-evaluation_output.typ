...
#figure(
  image("../uml/png/Dominio/RequirementEvaluationResult.png", width: 50%),
...
_RequirementEvaluationDetail_ è un oggetto immutabile che consolida tutte le informazioni di un requisito (anagrafica, albero, nodi) e il relativo stato di valutazione nel contesto di un asset. È concepito per arricchire il risultato grezzo con i testi completi.
