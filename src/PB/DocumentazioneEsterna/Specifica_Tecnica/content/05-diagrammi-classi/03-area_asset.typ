...
Il diagramma delle classi illustra la progettazione architetturale per il modulo di Gestione degli Asset. \ Un Asset rappresenta una componente fisica o logica di un Dispositivo (es. modulo Wi-Fi, interfaccia web) e viene sempre gestito nel contesto del Dispositivo padre, identificato tramite device_id.
