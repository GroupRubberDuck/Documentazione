...
#figure(
  image("../uml/png/CommitSession/CommitEvaluationSession.png", width: 110%),
...
_CommitEvaluationSessionUseCase_ è l'interfaccia (Inbound Port) che definisce il contratto per eseguire il consolidamento (commit) dei dati di una sessione di valutazione attiva, applicando definitivamente le modifiche all'entità dispositivo associata. Viene implementata a livello applicativo dal _CommitEvaluationSessionService_ e utilizzata dal controller _EvaluationSessionController_.
...
#figure(
  image("../uml/png/CommitSession/CommitEvaluationSessionService.png", width: 70%),
