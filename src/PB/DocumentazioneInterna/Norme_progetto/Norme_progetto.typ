...
#import "/src/PB/DocumentazioneInterna/Glossario.typ" : dict
...
#let modifiche=(
  ...
  ([1.4.0],[2026-05-18],[Ana Maria Draghici],[-],[Spostato da Pdq e integrato la sezione di automiglioramento @processo_miglioramento]),
)
