...
#let req-name="Metriche di qualitã "
#let data =(
  codice:[
  ...
  fonti:[
    ...
    #link("https://grouprubberduck.github.io/Documentazione/output/RTB/DocumentazioneEsterna/Piano_di_qualifica/Piano_di_qualifica-v1.0.0.pdf")[Piano di Qualifica v1.0.0];
  ]
)