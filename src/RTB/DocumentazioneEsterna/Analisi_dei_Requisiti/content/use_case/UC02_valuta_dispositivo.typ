...
#let use-case-nome="Valuta dispositivo"
...
#use-case-template(
    ...
    pre-condizioni:[
        - Il sistema è attivo
        - Nel sistema non sono sessioni di valutazione del dispositivo attive
        - Nel sistema non sono sessioni di modifica del modello attive
    ],
    ...
    trigger:[
        L'utente seleziona un dispositivo per la valutazione
    ],
