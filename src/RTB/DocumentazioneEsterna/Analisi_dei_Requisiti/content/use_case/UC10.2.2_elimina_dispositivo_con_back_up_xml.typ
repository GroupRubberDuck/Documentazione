...
#let use-case-nome="Elimina dispositivo con back up XML"
...
#use-case-template(
    ...
    scenario-principale:[
        ...
        + L'utente scarica un file XML contenente i dati del dispositivo sul proprio file system
    ...
    post-condizioni:[
        ...
        - L'utente ha scaricato un file XML contenente i dati del dispositivo
    ],
