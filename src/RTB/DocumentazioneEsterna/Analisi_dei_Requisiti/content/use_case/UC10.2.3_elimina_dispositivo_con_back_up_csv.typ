...
#let use-case-nome="Elimina dispositivo con back up CSV"
...
#use-case-template(
    ...
    scenario-principale:[
        ...
        + L'utente scarica un file CSV contenente i dati del dispositivo sul proprio file system
    ...
    post-condizioni:[
        ...
        - L'utente ha scaricato un file CSV contenente i dati del dispositivo
    ],
