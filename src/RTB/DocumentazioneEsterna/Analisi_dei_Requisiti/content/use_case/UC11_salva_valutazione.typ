...
#use-case-template(
    ...
    post-condizioni:[
        - Il sistema ha aggiornato la rappresentazione del dispositivo sul sistema di permanenza interno
    ],
    
    trigger:[
        L'utente seleziona la funzionalità di salvataggio della valutazione
    ],
