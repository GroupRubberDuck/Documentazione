...
#let use-case-nome="Visualizza stato valutazione requisito da lista requisiti"
...
#use-case-template(
    ...
    scenario-principale: [
        + L'utente visualizza lo stato di valutazione del requisito nel contesto dell'asset
    ],
