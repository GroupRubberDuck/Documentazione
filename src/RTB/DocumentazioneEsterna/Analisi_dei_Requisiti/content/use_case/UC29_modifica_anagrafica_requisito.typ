...
#let diagram=diagram-type(
  ...
  includes: (
    ...
    "Inserisci descrizione normativa requisito",
  ),
  extends: (:),
  generalizations: (),
  spacing: (2.5cm, 2cm), 
...
#use-case-template(
    ...
    scenario-principale:[
      ...
      + L'utente inserisce la descrizione normativa del requisito #use-case-label(nome-etichetta: "Inserisci descrizione normativa requisito")
    ],
    ...
    inclusioni:[
      ...
      - #use-case-label(nome-etichetta: "Inserisci descrizione normativa requisito")
    ],
