...
#let use-case-nome="Errore struttura non valida per il salvataggio"
...
#use-case-template(
    ...
    scenario-principale:[
        + L'utente cerca di salvare una struttura non valida
        + Il sistema mostra un messaggio di errore esplicativo

    ],
    
    pre-condizioni:[
        - Nel sistema è aperta una sessione di modifica della struttura del modello
    ],
