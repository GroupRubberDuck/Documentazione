...
#let use-case-nome="Errore modifica nome requisito non valido"
...
#use-case-template(
    ...
    post-condizioni:[
        ...
        - L'utente può ritentare l'inserimento del nome del requisito
    ],
 
    
    trigger:[
              L'utente ha inserito un nome del requisito non valido
    ],
