...
#let use-case-nome="Inserisci nome requisito"
#let depth=3
...
#let diagram=diagram-type(
  ...
  actors: ("Utente",),
  includes: (),
  extends: ("Errore nome requisito non valido":[
    L'utente ha inserito un nome non valido per il requisito
  ]),
  generalizations: (),
  spacing: (2.5cm, 2cm), 
  diagram-scale: 80%,
...
#use-case-template(
    ...
    pre-condizioni:[
        - L'utente sta modificando il l'anagrafica del requisito
    ],
    
    
    post-condizioni:[
        - L'utente ha inserito il nome del requisito
    ],
