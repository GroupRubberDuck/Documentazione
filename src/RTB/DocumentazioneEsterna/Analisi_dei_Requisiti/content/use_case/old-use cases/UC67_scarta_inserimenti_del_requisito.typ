...
#let use-case-nome="Scarta inserimenti del requisito"
#let depth=1
#use-case-template(
    ...
    scenario-principale:[
        + Il sistema scarta le modifiche apportate al requisito sulla bozza operativa
    ...
    trigger:[
        L'utente ha selezionato la funzionalità di annullamento delle modifiche del requisito
    ],
