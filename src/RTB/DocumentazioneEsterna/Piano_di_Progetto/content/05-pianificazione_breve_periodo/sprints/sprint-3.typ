...
#let sprint_data = (
  ...
  retrospettiva: [
    ...
    - *Scelte tecnologiche preliminari (PoC)*:
      È stato avviato un brainstorming sulle tecnologie per il Proof of Concept (PoC). Sebbene non siano state prese decisioni definitive, il gruppo si è orientato preliminarmente verso un approccio Web-based, riconoscendo però la necessità di approfondire lo studio nel prossimo sprint.
