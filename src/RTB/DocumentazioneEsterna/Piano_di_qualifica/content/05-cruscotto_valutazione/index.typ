...
#he(body: "Planned Value (PL) e Earned Value (EV)", level: 2)
#include "MPC/01-pv_vs_ev.typ"

#he(body: "Actual Cost (AV) e Estimate To Complete (ETC)", level: 2)
#include "MPC/02-ac_vs_etc.typ"

#he(body: "Cost Performance Index (CPI) e Schedule Performance Index (SPI)", level: 2)
#include "MPC/03-cpi_vs_spi.typ"
