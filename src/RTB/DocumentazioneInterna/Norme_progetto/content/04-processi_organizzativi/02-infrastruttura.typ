...
Le attività di manutenzione vengono svolte nei seguenti casi:
- Introduzione di una nuova automazione;
- Dismissione di automazioni divenute obsolete;
- Correzione di automazioni errate o non più funzionanti.
