...
#he(body:"Introduzione", level:3)
Il *processo di formazione* ha lo scopo di garantire che tutti i membri del team acquisiscano le competenze necessarie per contribuire efficacemente alle attività del progetto.  
Si tratta di un percorso continuo che combina sessioni strutturate e apprendimento autonomo, permettendo ai partecipanti di affrontare le sfide reali del progetto con consapevolezza e autonomia.

#he(body:"Scopo del processo", level:3)
Il processo mira a:
...
+ *Sessioni formative guidate su strumenti e metodologie* del progetto;
+ *Studio dei documenti di progetto e dei materiali* forniti dal docente;
+ *Esercitazioni pratiche* per l’applicazione delle conoscenze acquisite;
+  *Apprendimento autonomo e auto-valutazione* delle competenze.

#he(body:"Procedure operative", level:3)
 ==== Apprendimento libero
Non sempre un programma di apprendimento rigoroso riesce a rispondere in modo efficace alle esigenze reali e immediate che un membro del team può incontrare nello svolgimento di un task.  
...
Essendo un progetto svolto per la prima volta, ogni attività formativa viene registrata anche termini di ore non produttive.  
