...
Il tracciamento delle metriche viene effettuato all'interno del documento: #link("https://grouprubberduck.github.io/Documentazione/output/RTB/DocumentazioneEsterna/Piano_di_qualifica/Piano_di_qualifica-v1.0.0.pdf")[Piano di Qualifica].
...
+ *Metriche di qualità di prodotto*  – Misurano le caratteristiche intrinseche dei deliverable. \ In particolare #terms(
  ...
  ([*Affidabilità*],[
    Misura la capacità del software di operare senza guasti in condizioni previste, garantendo comportamenti consistenti e riducendo al minimo malfunzionamenti.
      - * Maturità*:\ #[Capacità dell'applicazione di evitare blocchi  a seguito di errori nel software].
      - *Tolleranza agli errori*: \ #[Capacità di mantenere determinati livelli di prestazione in caso di errori].
      - *Recuperabilità*: \ #[Capacità del software di ripristinare il proprio livello di prestazioni e di recuperare i dati direttamente interessati a seguito di un guasto o di un errore].
      - * Aderenza *: \ #[Capacità di aderire a standard di affidabilità].
  ]),
  ([*Efficienza*],[
  ...
  ([*Usabilità*],[
    ...
    - *Conformità*: \ #[Aderenza a standard di usabilità.]
...
- *Stabilità*: \ #[Capacità del prodotto di limitare effetti indesiderati derivanti da modifiche o aggiunte al prodotto.]
- *Testabilità*: \ #[Semplicità di testing del prodotto.]
  ...
  - *Conformità*: \ #[Aderenza alle convenzioni sulla portabilità.]
  - *Sostituibilità*: \ #[Facilità di migrazione da un  prodotto precedente al prodotto oggetto del progetto.]
  ]),
)
