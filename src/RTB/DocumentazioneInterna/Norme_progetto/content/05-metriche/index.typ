...
Le metriche rappresentano strumenti fondamentali per misurare, controllare e migliorare sia il processo di sviluppo sia i prodotti realizzati. Nelle norme progetto sono considerate tre principali categorie di metriche:
...
+ *Metriche di qualità di prodotto* – Misurano le caratteristiche intrinseche dei deliverable, come completezza, correttezza, affidabilità e conformità ai requisiti specificati.
