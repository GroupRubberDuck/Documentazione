...
#insertRomanNumberedPages("Registro Modifiche", doctype, giornoRiunione)[
  ...
  #let modifiche = (
    ([0.1.0], [2026-03-30], persone.ALDO, "", [Stesura del verbale]),
  )
...
#insertArabicNumberedPages("Riassunto della riunione", "Verbale interno", giornoRiunione)[
  ...
  Il tema principale della riunione è stato valutare l'adozione di vue.js al posto di JavaScript puro come frameworkper il frontend. Questo tema ha suscitato una discussione interna che si è conclusa con l'adozione di vue per maggioranza a favore.
  In seguito si sono delineate le attività successive di avanzamento per concludere la fase di RTB.

]

#insertArabicNumberedPages("Contenuto riunone", "Verbale interno", giornoRiunione)[
  ...
  La discussione si è quindi focalizzata sulle modalità di rimaneggiamento del budget interno per ottimizzare le risorse. È stata avanzata e dibattuta la proposta di convertire una quota delle ore previste per l'Analista in ore per i ruoli di Verificatore e Programmatore. Durante il confronto, sono stati valutati attentamente i vincoli economici: è stato ribadito l'obbligo tassativo di non superare il costo massimo preventivato, chiarendo al contempo che un costo finale leggermente inferiore alla stima non costituisce un problema. Al termine delle valutazioni, il gruppo ha approvato la ridistribuzione interna delle ore, concordando il conseguente aggiornamento dei documenti di pianificazione
...
#insertArabicNumberedPages("Decisioni", "Verbale interno", giornoRiunione)[
  ...
  #let decisioni = (
    (
      ...
      [Adottare Vue.js per il forntend],
