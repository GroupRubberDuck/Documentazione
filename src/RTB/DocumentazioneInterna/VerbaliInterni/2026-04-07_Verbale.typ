...
#insertArabicNumberedPages("TODO", "Verbale interno", giornoRiunione)[
  ...
  #let TODO = (
    ...
    (
      [#getCode(prefisso: prefisso, contatore: contatoreTodo)],
      [Tutto il gruppo],
      [Studio del documento di Specifica Tecnica],
      [VI.20.4],
    ),
    (
      [#getCode(prefisso: prefisso, contatore: contatoreTodo)],
      [Tutto il gruppo],
      [Studio delle modalità di realizzazione e descrizione formale l'architettura scelta],
      [VI.20.4],
    )
  )
  #utilityTable(
