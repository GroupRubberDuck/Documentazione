...
Di seguito si descrive l'algoritmo utilizzato per la valutazione automatica della leggibilità della documentazione di progetto tramite l'indice di Gulpease.

#he(body:"La Formula",level:level+1)
...
#he(body:"Pipeline di Elaborazione",level:level+1)
...
#he(body:"Definizione delle Variabili",level:level+1)


Per garantire coerenza, sono state adottate le seguenti definizioni rigorose:

#he(body:"Conteggio delle Parole",level:level+2)
...
#he(body:"Conteggio delle Lettere ",level:level+2)
...
#he(body:"Conteggio delle Frasi",level:level+2)
...
#he(body:"Gestione degli elementi strutturali",level:level+1)

#he(body:"Elementi da sanificare",level:level+2)
...
#he(body:"Elementi Esclusi dal Calcolo",level:level+2)
...
- *Formule Matematiche ('math.equation'):* Le espressioni matematiche  costituiscono un linguaggio simbolico distinto dalla prosa discorsiva.  

Le regole ortografiche e sintattiche sono diverse, la loro inclusione introdurrebbe un "rumore" significativo, falsando il calcolo della leggibilità.

#he(body:"Interpretazione dei Risultati",level:level+2)
...
#he(body:"Codice sorgente",level:level+2)
